...
% 0.a Path to directories 
  ...
  out_dir = '../OUTPUT-PATH_GSH/';                  % output directory
...
% 0.b Design grid parameters
  ...
  fname = 'gsh_1deg';                  % file name prefix 
  
  grid_box = [-79.5 0 -10.5 360];       % starting and ending lat,lon for grid 
                                     % domain. Longitude data is always
                                     % defined from 0 to 360
  dx = 60.0/60.0;                    % grid resolution in x (degrees)
  dy = 60.0/60.0;                    % grid resolution in y (degrees)
